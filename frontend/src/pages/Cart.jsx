          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="lg:w-2/3">
              <div className="flex justify-between items-end mb-12 border-b border-gold-600/10 pb-8">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold-600">{items.length} Items</span>
              </div>
              ...
              {items.length === 0 ? (
                <div className="py-24 text-center border border-gold-600/10 bg-navy-950/50">
                  ...
                  <Link to="/products" className="inline-block bg-gold-600 text-navy-950 px-12 py-5 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-gold-500 transition-all">
                    Start Shopping
                  </Link>
                </div>
              ) : (
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div className="flex justify-between items-start">
                            <div className="space-y-2">
                              <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold-600/50">{item.brand || 'Bespoke'}</p>
              ...
              <div className="bg-navy-950/50 p-10 border border-gold-600/10 sticky top-32 space-y-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest">
                    ...
                    <span className="text-gold-500 italic lowercase font-light">Calculated at checkout</span>
                  </div>
