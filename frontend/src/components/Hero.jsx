  ...
  return (
    <section className="hero-section relative h-screen flex items-center overflow-hidden bg-navy-950">
        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-6 sm:space-y-0 sm:space-x-8 pt-8">
              <Link 
                to="/products"
                className="bg-gold-600 text-navy-950 px-12 py-5 text-[10px] font-bold  tracking-[0.2em] hover:bg-gold-500 transition-all flex items-center space-x-4 group"
              >
              ...
              <button className="flex items-center space-x-4 group">
                ...
                <span className="text-gold-500 text-[10px] font-bold  tracking-[0.2em]">Watch Film</span>
              </button>
            </div>
          </motion.div>
        </div>
      ...
      <div className="absolute right-10 bottom-20 origin-right rotate-90 hidden lg:block">
        <p className="text-gold-600/30 text-[10px] font-bold tracking-[1em] ">Prince Esquare · 2026</p>
      </div>
    </section>
  );
};
